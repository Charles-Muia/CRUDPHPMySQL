...
if (isset($_POST['u_name']) && $_POST['u_email'] && $_POST['u_card'] && isset($_POST['u_mobile']) !== null) {
    $insert_data = insertData($conn, $_POST['u_name'], $_POST['u_email'], $_POST['u_card'], $_POST ['u_mobile']);
    if ($insert_data === true) {
        ...
        <div class="wrapper">
            <div class="form">
                <form method="POST">
                    ...
                    <label for="userCard">ID / Passport</label>
                    <input type="text" name="u_card" id="userNumber" placeholder="ID / Passport No." autocomplete="off" required>
                    <label for="userMobile">Mobile Number</label>
                    <input type="text" name="u_mobile" id="userMobile" placeholder="Mobile No." autocomplete="off" required>
    ...
    <script>
        ...
        delteAction.forEach((el) => {
            el.onclick = function(e) {
                e.preventDefault();
                if (confirm('You are about to delete the record, are you sure?')) {
